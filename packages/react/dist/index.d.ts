...
import * as Toast$2 from '@radix-ui/react-tooltip';
...
declare const AvatarImageStyled: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Avatar$1.AvatarImageProps & react.RefAttributes<HTMLImageElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        test: string;
...
interface AvatarProps extends ComponentProps<typeof AvatarImageStyled> {
}
...
declare const CheckboxContainerStyled: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Checkbox$1.CheckboxProps & react.RefAttributes<HTMLButtonElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        test: string;
...
interface CheckboxProps extends ComponentProps<typeof CheckboxContainerStyled> {
}
...
declare function MultStep({ size, currentStep }: MultStepProps): JSX.Element;
declare namespace MultStep {
    var displayName: string;
}

declare const ToastContainerStyled: _stitches_react_types_styled_component.StyledComponent<react.FC<Toast$1.ToastProviderProps>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        test: string;
...
declare const ToolTipContainerStyled: _stitches_react_types_styled_component.StyledComponent<react.FC<Toast$2.TooltipProviderProps>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        test: string;
...
interface TooltipProps extends ComponentProps<typeof ToolTipContainerStyled> {
    content: string;
}
declare function Tooltip({ content, ...props }: TooltipProps): JSX.Element;

export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, Checkbox, CheckboxProps, Heading, HeadingProps, MultStep, MultStepProps, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps, Toast, ToastProps, Tooltip, TooltipProps, formattedDate };
